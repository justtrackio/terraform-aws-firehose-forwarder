...
| <a name="module_kinesis_stream"></a> [kinesis\_stream](#module\_kinesis\_stream) | justtrackio/kinesis/aws | 1.0.2 |
...
| <a name="input_alarm_enabled"></a> [alarm\_enabled](#input\_alarm\_enabled) | Whether or not to create alarms | `bool` | `false` | no |
