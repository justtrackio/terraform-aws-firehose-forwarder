...
| <a name="input_dynamic_partitioning_lambda_buffer_size"></a> [dynamic\_partitioning\_lambda\_buffer\_size](#input\_dynamic\_partitioning\_lambda\_buffer\_size) | Lambda transformer buffer size in MB | `number` | `null` | no |
